<?php
  ...
  if(isset($_POST["editPartners"])) {
    ...
    queryManipulation("UPDATE partners SET company=?, email=?, link=?, description=?, headquarter=?, field=?, create_at=? WHERE id_partners=?", "set", [$company, $email, $link, $description, $headquarter, $field, $createAt, $getIdPartners]);
  }
?>
