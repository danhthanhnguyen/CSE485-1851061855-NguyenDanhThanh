...
<html lang="en">
  ...
  <body>
            ...
            <div class="container">
              <div class="row">
                <div class="col-12 page-header">
                  <h2 class="heading text-center">Add Skills</h2>
                </div>
              </div>
              <div class="row">
                  ...
                  <div class="box-body">
                    <div class="skills-information">
                      ...
                      <dl class="form-group">
                        ...
                        <dd>
                          <input class="field-data form-control" id="skills-icon" type="text" spellcheck="false" name="skills-icon" required readonly/>
                        </dd>
                      </dl>
                    </div>
                    <button name="add-skills-info" class="btn btn-success mt-3 mb-2" type="button" onclick="addSkills()">Add</button>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="../js/add_skills.js"></script>
  </body>
</html>